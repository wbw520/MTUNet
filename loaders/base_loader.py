...
def get_dataloader(args, split, shuffle=True, out_name=False, sample=None, selection=None):
    # sample: iter, way, shot, query
    transform = datasets.make_transform(args, split)
    sets = datasets.DatasetFolder(args.data_root, args.dataset, split, transform, out_name=out_name, cls_selction=selection)
